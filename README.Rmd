...
The `statficlassifications` allows the access of Statistics Finland classifications API from within R. Gets correspondence tables or how the package calls them, classification keys or just keys. Provides tools for reclassifying regions in data. 
